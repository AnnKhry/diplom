package com.example11.demo.model;
...
public class MailSender {
    public static void sendmail() throws AddressException, MessagingException, IOException {
        ...
        msg.setRecipients(Message.RecipientType.TO, InternetAddress.parse("chrisanfowa@mail.ru"));
...
//
//        attachPart.attachFile("emailfile.html");
